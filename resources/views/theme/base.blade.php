...
<html lang="en">
    ...
    <body class="landing-page">
        ...
        <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light py-2">
            <div class="container">
                <a class="navbar-brand mr-lg-5" href="{{ route('appHome') }}">
                    ANKESH STRIPE
                </a>
                ...
                <div class="navbar-collapse collapse" id="navbar_global">
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                        @if(auth()->check())
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="tooltip" title="{{ auth()->user()->first_name.' '.auth()->user()->last_name }}">
                                    {{ auth()->user()->first_name.' '.auth()->user()->last_name }}
                                </a>
                            </li>
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('loginForm') }}" data-toggle="tooltip" title="Login">
                                    Login
                                </a>
                            </li>
                        @endif
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <div class="row align-items-center justify-content-md-between">
                        <div class="col-md-6">
                            <div class="copyright">
                                &copy; {{ date('Y') }} <a href="" target="_blank">ANKESH STRIPE</a>.
                            </div>
                        </div>
                        <div class="col-md-6">
        ...
        <script src="{{ asset('assets/js/argon-design-system.js') }}" type="text/javascript"></script>
    @stack('script')
    </body>
</html>
